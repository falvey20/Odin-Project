...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when random number is 4 and previous step is 10' do
      it 'returns 6' do
        game = described_class.new(random_number = 4)
        previous_step = 10
  ...
  describe '#play' do
    context 'when the random number is 18' do
      ...
      it 'will return 7' do
        game = described_class.new(random_number = 18)
        result = game.play
    ...
    context 'when the random number is 11' do
      # remove the 'x' before running this test
      it 'will return 7' do
        game = described_class.new(random_number = 11)
        result = game.play
        expect(result).to eq(7)
      end
    end
    ...
    context 'when the random number is 3' do
      # remove the 'x' before running this test
      it 'will return 7' do
        game = described_class.new(random_number = 3)
        result = game.play
        expect(result).to eq(7)
      end
    end
