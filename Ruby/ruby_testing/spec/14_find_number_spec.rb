...
describe FindNumber do
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:number_end) { double('random_number', value: 5) }
      subject(:game_end) { described_class.new(0, 9, number_end, 5) }
    ...
    context 'when guess and random_number are not equal' do
      let(:number_not_end) { double('random_number', value: 5) }
      subject(:game_mid) { described_class.new(0, 9, number_not_end, 4) }
